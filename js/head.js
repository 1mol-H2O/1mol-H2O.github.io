    ...
    .then((data) => {
        ...
        for (let e of elements) {
            ...
            if (e.tagName === 'LINK' || e.tagName === 'META') {
                ...
                console.info(`head.html 已填充：${e.tagName}.`);
                ...
                // 添加到当前文档的 head 中
                console.info(`head.html 已新建：${e.tagName}.`);
            }
        }
        console.info(`head.html 填充完成.`);
    })
    .catch((error) => {
